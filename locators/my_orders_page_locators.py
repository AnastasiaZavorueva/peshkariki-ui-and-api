...
class MyOrdersPageLocators:
    ...
    ALL_NUMBERS_OF_ALL_ORDERS = (By.XPATH, "//li[@class='order']//h5/a")
    ALL_CARDS_OF_ALL_ORDERS = (By.XPATH, "//ul[@class='main-orders-list']//li[@class='order']")
    ...
    TOTAL_VALUE_SHOWN = (By.XPATH, "//ul[@class='main-orders-list']//li[@class='order']//li[contains(text(), 'Цена:')]")
